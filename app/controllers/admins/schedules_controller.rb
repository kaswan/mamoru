class Admins::SchedulesController < Admins::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @schedule.save
        ...
        format.json { render :show, status: :created, location: [:admins, @schedule] }
      else
  ...
  def update
    respond_to do |format|
      if @schedule.update(schedule_params)
        ...
        format.json { render :show, status: :ok, location: [:admins, @schedule] }
      else
